...
function receivedMessage(event) {
  ...
  console.log("Received message for user %d with message:",
    ...
    request(
      ("https://graph.facebook.com/v2.6/" + senderID + "?fields=first_name,last_name,profile_pic,locale,timezone,gender,last_ad_referral,hometown&access_token=" + PAGE_ACCESS_TOKEN),
